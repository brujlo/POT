...
/*public List<String> Qcommands(String Uname, String Pass, List<String> value, String what)
        {
            List<String> arr = new List<string>();
            ...
            if (cn.TestConnection(cnn))
            {
                switch (what)
                {
                    case "DBUser":
                        {
                            ...
                            {
                                //WorkingUser.UserID = Int32.Parse(dataReader["UserID"].ToString());
                                WorkingUser.UserID = dataReader.GetDecimal(0);
                                WorkingUser.Name = dataReader.GetString(1);
                                WorkingUser.Surename = dataReader.GetString(2);
                                WorkingUser.Username = dataReader.GetString(3);
                                WorkingUser.Password = dataReader.GetString(4);
                                WorkingUser.Phone = dataReader.GetString(5);
                                WorkingUser.Email = dataReader.GetString(6);
                                WorkingUser.RegionID = dataReader.GetDecimal(7);
                                WorkingUser.AdminRights = dataReader.GetDecimal(8);
                            }
                            arr.Add(dataReader["UserID"].ToString());
                            dataReader.Close();
                    ...
                    case "User":
                        {
                            query = "Select * from Users where UserID = " + int.Parse(value[0]);
                            command = new SqlCommand(query, cnn);
                            command.ExecuteNonQuery();
                            SqlDataReader dataReader = command.ExecuteReader();
                            dataReader.Read();
                    ...
                    case "NewDBUser":
                        {
                            ...
                            {
                                arr.Add("User is not specified to add.");
                            }
                            break;
                        }
                    case "DeleteDBUser":
                        {
                            ...
                            if (value[0] != "" && value[1] != "")
                            {
                                try
                                {
                                    ...
                                    command.CommandText = "EXEC sp_dropuser '" + value[0] + "'";
                                    command.ExecuteNonQuery();

                                    command.CommandText = "DROP LOGIN " + value[0];
                                    command.ExecuteNonQuery();

                                    command.CommandText = "DELETE FROM Users WHERE UserID='" + value[1] + "'";
                                    command.ExecuteNonQuery();
                            ...
                            {
                                arr.Add("User is not specified to delete.");
                            }
                            break;
                        }
                    case "RegionInfo":
                    ...
                    case "PartInfo":
                        {
                            query = "Select * from Sifrarnik where FullCode = " + long.Parse(value[0]);
                            command = new SqlCommand(query, cnn);
                            command.ExecuteNonQuery();
                            SqlDataReader dataReader = command.ExecuteReader();
                            dataReader.Read();
                            ...
                            if (dataReader.HasRows)
                            {
                                arr.Add(dataReader["CategoryCode"].ToString());
                                arr.Add(dataReader["CategoryName"].ToString());
                                arr.Add(dataReader["PartCode"].ToString());
                                arr.Add(dataReader["PartName"].ToString());
                                arr.Add(dataReader["SubPartCode"].ToString());
                                arr.Add(dataReader["SubPartName"].ToString());
                                arr.Add(dataReader["PartNumber"].ToString());
                                arr.Add(dataReader["PriceInKn"].ToString());
                                arr.Add(dataReader["PriceOutKn"].ToString());
                                arr.Add(dataReader["PriceInEur"].ToString());
                                arr.Add(dataReader["PriceOutEur"].ToString());
                                arr.Add(dataReader["FullCode"].ToString());
                                arr.Add(dataReader["FullName"].ToString());
                                arr.Add(dataReader["Packing"].ToString());
                            }
                            else
                            {
                                arr.Add("nok");
                    ...
                    case "ListPartsByCodeRegionState":
                        {
                            query = "Select * from Parts where CodePartFull = " + long.Parse(value[0]) + " and StorageID = " + long.Parse(value[1]) + " and State = '" + value[2] + "'";
                            command = new SqlCommand(query, cnn);
                            command.ExecuteNonQuery();
                            SqlDataReader dataReader = command.ExecuteReader();
                            dataReader.Read();
                    ...
                    case "SelectNameCodeFromSifrarnik":
                        {
                            query = "Select FullName, FullCode from Sifrarnik order by FullName asc";
                            command = new SqlCommand(query, cnn);
                            command.ExecuteNonQuery();
                    ...
                    case "CompanyInfo":
                        {
                            query = "Select * from Tvrtke where Code = '" + value[0] +"'";
                            command = new SqlCommand(query, cnn);
                            command.ExecuteNonQuery();
                            SqlDataReader dataReader = command.ExecuteReader();
                            dataReader.Read();
                    ...
                    case "CompanyInfoByName":
                        {
                            query = "Select * from Tvrtke where Name = '" + value[0] + "'";
                            command = new SqlCommand(query, cnn);
                            command.ExecuteNonQuery();
                            SqlDataReader dataReader = command.ExecuteReader();
                            dataReader.Read();
                    ...
                    case "CompanyInfoByRegionID":
                        {
                            query = "Select * from Tvrtke where RegionID = " + long.Parse(value[0]);
                            command = new SqlCommand(query, cnn);
                            command.ExecuteNonQuery();
                            SqlDataReader dataReader = command.ExecuteReader();
                            dataReader.Read();
                    ...
                    case "InTransport":
                        {
                            query = "select Count(CodePartFull) from Parts p where p.CodePartFull =" + value[0] + " and p.StorageID = 6";
                            command = new SqlCommand(query, cnn);
                            command.ExecuteNonQuery();
                            SqlDataReader dataReader = command.ExecuteReader();
                            dataReader.Read();
                    ...
                    case "AddRegion":
                        {
                            query = "select Count(RegionID) from Regija r where r.RegionID =" + value[0];
                            command = new SqlCommand(query, cnn);
                            command.ExecuteNonQuery();
                            SqlDataReader dataReader = command.ExecuteReader();
                            dataReader.Read();
                            ...
                            else
                            {
                                ...
                                if (value[0] != "" && value[1] != "" && value[2] != "")
                                {
                                    try
                                    {
                                        command.CommandText = "INSERT INTO Regija (RegionID, Region, FullRegion) values (" + value[0] + ", '" + value[1] + "', '" + value[2] + "')";
                                        command.ExecuteNonQuery();
                                        transaction.Commit();
                    ...
                    case "DeleteRegion":
                        {
                            ...
                            if (value[0] != "")
                            {
                                ...
                                {
                                    command.CommandText = "DELETE FROM Regija WHERE RegionID =  @word";
                                    command.Parameters.AddWithValue("@word", int.Parse(value[0]));
                                    result = command.ExecuteNonQuery();
                                    transaction.Commit();
                    ...
                    case "PartsCntG":
                        {
                            query = "select Count(CodePartFull) from Parts p where p.CodePartFull = " + long.Parse(value[0]) + " and p.StorageID = " + value[1] + " and p.State = 'g'";
                            command = new SqlCommand(query, cnn);
                            command.ExecuteNonQuery();
                            SqlDataReader dataReader = command.ExecuteReader();
                            dataReader.Read();
                    ...
                    case "PartsCntNG":
                        {
                            query = "select Count(CodePartFull) from Parts p where p.CodePartFull = " + long.Parse(value[0]) + " and p.StorageID = " + value[1] + " and (p.State = 'ng' or p.State = 's')";
                            command = new SqlCommand(query, cnn);
                            command.ExecuteNonQuery();
                            SqlDataReader dataReader = command.ExecuteReader();
                            dataReader.Read();
                    ...
                    case "CompareCodeSNCN":
                        {
                            query = "Select PartID from Parts where CodePartFull = " + long.Parse(value[0]) + " and SN = '" + value[1] + "' and CN = '" + value[2] + "' and StorageID = " + long.Parse(value[2]);
                            command = new SqlCommand(query, cnn);
                            command.ExecuteNonQuery();
                            SqlDataReader dataReader = command.ExecuteReader();
                            dataReader.Read();
