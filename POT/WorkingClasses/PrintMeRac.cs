...
namespace POT.WorkingClasses
{
    class PrintMeRac
    {
        ...
        public PrintMeRac(Company _cmpS, Company _cmpR, List<String> _sifrarnikArr, List<Part> _partListPrint, String _PrimkaNumber, String _napomenaPRIMPrint, String _DocumentName, String _recipientSender, Boolean _Signature)
        {
            cmpR = _cmpR;
            cmpS = _cmpS;
